...
/**
 * Package: oms.mmc.android.fast.framwork.sample
 * FileName: AppCompatCommonOperationDelegateActivity
 * Date: on 2018/3/21  上午11:41
 * Auther: zihe
 * Descirbe:
 * Email: hezihao@linghit.com
 */

public abstract class AppCompatCommonOperationDelegateActivity extends AppCompatSupportLifecycleActivity implements IArgumentsDelegate,
    ...
    public CharSequence getViewTextWithTrim(TextView view) {
        return getViewFinder().getViewTextWithTrim(view);
    }
