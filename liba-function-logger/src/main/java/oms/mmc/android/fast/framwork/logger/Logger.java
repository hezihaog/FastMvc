package oms.mmc.android.fast.framwork.logger;
...
import oms.mmc.android.fast.framwork.logger.utils.ArrayUtil;
import oms.mmc.android.fast.framwork.logger.utils.SystemUtil;
...
public final class Logger implements Printer {
    ...
    private String generateTag(StackTraceElement caller) {
        ...
        String Prefix = TextUtils.isEmpty(L.getTagPrefix()) ? "" : L.getTagPrefix();
