...
public abstract class BaseStickyListActivity<T> extends BaseActivity implements ListLayoutCallback<T>, OnItemClickListener, OnStateChangeListener<ArrayList<T>>, OnItemLongClickListener {
    /**
     * 下来刷新控件
     */
    ...
    public void onApiFailure(Throwable t, int errorNo, String strMsg, String tag) {
        BaseMMCFastApplication.showToast("网络请求错误," + t.getMessage());
        t.printStackTrace();
        onApiError(tag);
    }
