...
public abstract class CommonOperationDelegateFragment extends ExtendLazyFragment implements IArgumentsDelegate, IWaitViewHandler, IViewFinderAction, IToast {
    ...
    protected boolean hasBindFragment() {
        return FragmentUtil.hasFragment(getChildFragmentManager());
    }
    ...
    protected Fragment addFragment(Fragment fragment, int containerId) {
        return FragmentUtil.addFragment(getChildFragmentManager(), fragment, containerId);
    }
    ...
    protected Fragment replaceFragment(Fragment fragment, @IdRes int containerViewId) {
        return FragmentUtil.replaceFragment(getChildFragmentManager(), fragment, containerViewId, false);
    }
    ...
    protected void removeFragments() {
        FragmentUtil.removeFragments(getChildFragmentManager());
    }
    ...
    protected void removeAllFragment() {
        FragmentUtil.removeAllFragments(getChildFragmentManager());
    }
    ...
    protected void hideAllFragment() {
        FragmentUtil.hideFragments(getChildFragmentManager());
    }
